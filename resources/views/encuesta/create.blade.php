                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content bg-white">
                      ...
                      <div class="modal-body">
                          ...
                          (*) Cuenta con un <code>CASO POSITIVO DE COVID.</code> Por favor contactarse con el área de seguridad y salud laboral (SSL), para dar continuidad al protocolo de atención ante factores de riesgo: 
                          <table class="table table-responsive table-hover">
                            <thead>
                              <tr>
                                @if ($url=='http://encuesta.palmar.com.co')<th>Palmeras</th>@endif
 ...
 <table class="table table-condensed table-hover" id="infopersonal">
     ...
     <tbody>
         <tr>
             ...
             <lu>
                 <li><strong>Bienvenido Empleado:</strong> {{$empleados->FullName}}</li>
                 <li><strong>Empresa:</strong> {{$empleados->EMPRESA}}</li>
                 <li><strong>Cargo:</strong> {{$empleados->CARGO}}</li>
         ...
         <tr>
             <td>
                 <lu id="tipotrabajo">
                     <li><strong>Tipo de Trabajo:</strong> {{$tipotrabajo}}</li>
                     <li><strong>Subtipo:</strong> {{$tipotrabajo2}}</li>
