            ...
            <tr>
                <td>
                   ...
                   <div class="form-group">  
                     ...
                     {!! Form::select('trabajo',[ ''=>'Presencial en donde?...','Presencial en Oficina '=>'Presencial en Oficina ', 'Exterior de la Oficina' =>'Exterior de la Oficina '],null,['class'=> 'tipo ocultar form-control','name'=>'trabajo' ,'id'=>'trabajo1','required'] )!!}
